...
public class A013 {
	...
	//Run your program again.Is the output the same? It's math magic!
		
		int myNumber=7; //original number
		...
		String finish="The magic number is ";
		
		System.out.println(finish+stepSix+ "!");
